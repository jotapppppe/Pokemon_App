...
import pygame
from cod.entrenadores import *
from cod.Funciones import *
...
music_paths = {
    "Primera Generación": "docs/music/Palette_Town - FRLG.mp3",
    "Segunda Generación": "docs/music/National_Park - HGSS.mp3",
    "Tercera Generación": "docs/music/Route_120 - RSE.mp3",
    "Cuarta Generación": "docs/music/Route_209 - DPP.mp3",
...
icono = tk.PhotoImage(file="docs/imag/pokeicon.png")
...
background_image2 = tk.PhotoImage(file="docs/mapas_pkmn/johto_map.png")
background_image3 = tk.PhotoImage(file="docs/mapas_pkmn/hoenn_map.png")
background_image4 = tk.PhotoImage(file="docs/mapas_pkmn/sinnoh_map.png")
background_image5_1 = tk.PhotoImage(file="docs/mapas_pkmn/unova_map.png")
background_image5_2 = tk.PhotoImage(file="docs/mapas_pkmn/unova_map_2.png")
